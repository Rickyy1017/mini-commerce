  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
          ...
          >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-2 py-1 bg-red-200 text-red-600 cursor-pointer rounded"
              >
                −
              </button>
              ...
              <button
                ...
                className="px-2 py-1 bg-green-200 cursor-pointer text-green-600 rounded"
              >
                +
              </button>
              <button
                onClick={() => removeFromCart(item.id)}
                className="ml-4  cursor-pointer text-red-600 text-sm"
              >
                Remove
              </button>
            </div>
      ...
      <div className="mt-10 border-t pt-4 text-right">
        ...
        <Link
          href="/"
          className="inline-block mt-4 mr-4 bg-red-600 text-white px-6 py-2 rounded hover:bg-gray-700 transition"
        >
          Continue Shopping
        </Link>
        <Link
