    ...
    <div className="max-w-4xl mx-auto px-4 py-10">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <p className="text-indigo-600 text-2xl font-bold cursor-pointer">
            ₦{product.price.toLocaleString()}
          </p>

          <button
            onClick={handleAddToCart}
            className="bg-indigo-600 text-white px-6 py-3 rounded font-medium hover:bg-indigo-700 transition cursor-pointer"
          >
            Add to Cart
          </button>
        </div>
