      ...
      <section className="flex flex-col md:flex-row gap-6 justify-between items-center">
        ...
        <div className="flex gap-4 flex-wrap">
          <select
            ...
            className="border text-gray cursor-pointer border-gray-300 px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
          ...
          <select
            ...
            className="border cursor-pointer border-gray-300 px-4 py-3 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
