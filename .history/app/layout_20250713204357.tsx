...
export const metadata: Metadata = {
  ...
  description: 'Shop the best smartphones at unbeatable prices with fast delivery across Nigeria. Buy now from Mini-Commerce!',
  metadataBase: new URL('https://mini-commerce.vercel.app'), // change if different
  openGraph: {
    title: 'Mini-Commerce | Buy Smartphones Online in Nigeria',
    description: 'Shop the best smartphones at unbeatable prices with fast delivery across Nigeria. Buy now from Mini-Commerce!',
  ...
  twitter: {
    ...
    title: 'Mini-Commerce | Buy Smartphones Online in Nigeria',
    description: 'Shop the best smartphones at unbeatable prices with fast delivery across Nigeria.',
    images: ['/og-image.png'],
