    ...
    <div className="max-w-7xl mx-auto px-4 py-10 space-y-12">
      ...
      <section className="flex flex-col md:flex-row gap-6 justify-between items-center">
        <input
          ...
          className="border border-gray-300 dark:text-white lighttext-black px-4 py-3 rounded-lg shadow-sm w-full md:max-w-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
        <DarkModeToggle />
