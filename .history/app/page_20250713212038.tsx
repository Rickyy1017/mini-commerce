    ...
    <div className="max-w-7xl mx-auto px-4 py-10 space-y-12">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        {filtered?.map((product) => (
          <div
            key={product.id}
            className="border border-gray-200 rounded-lg shadow  transition-shadow duration-400 ease-in-out p-4 flex flex-col transform perspective-1000 hover:scale-102 hover:rotate-1 hover:-translate-y-2 hover:shadow-2xl"
            data-aos="fade-up"
          >
            <Image
              src={product.image}
